...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.HistoricalStats.DestinyAggregateActivityResults")]
    public partial class DestinyHistoricalStatsDestinyAggregateActivityResults : IEquatable<DestinyHistoricalStatsDestinyAggregateActivityResults>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DestinyHistoricalStatsDestinyAggregateActivityResults);
        }

        /// <summary>
        /// Returns true if DestinyHistoricalStatsDestinyAggregateActivityResults instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyHistoricalStatsDestinyAggregateActivityResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyHistoricalStatsDestinyAggregateActivityResults input)
        {
            if (input == null)
            {
                return false;
