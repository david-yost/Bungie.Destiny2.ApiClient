...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Entities.Items.DestinyItemTalentGridComponent")]
    public partial class DestinyEntitiesItemsDestinyItemTalentGridComponent : IEquatable<DestinyEntitiesItemsDestinyItemTalentGridComponent>, IValidatableObject
    {
        ...
        /// <param name="gridProgression">gridProgression.</param>
        public DestinyEntitiesItemsDestinyItemTalentGridComponent(int talentGridHash = default(int), List<DestinyDestinyTalentNode> nodes = default(List<DestinyDestinyTalentNode>), bool isGridComplete = default(bool), DestinyDestinyProgression gridProgression = default(DestinyDestinyProgression))
        {
        ...
        [DataMember(Name = "isGridComplete", EmitDefaultValue = true)]
        public bool IsGridComplete { get; set; }

        /// <summary>
        /// Gets or Sets GridProgression
        /// </summary>
