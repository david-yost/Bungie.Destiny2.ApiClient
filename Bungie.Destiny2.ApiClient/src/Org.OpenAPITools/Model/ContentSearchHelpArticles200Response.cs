...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Content_SearchHelpArticles_200_response")]
    public partial class ContentSearchHelpArticles200Response : IEquatable<ContentSearchHelpArticles200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentSearchHelpArticles200Response" /> class.
        /// </summary>
        ...
        public ContentSearchHelpArticles200Response(Object response = default(Object), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentSearchHelpArticles200Response {\n");
        ...
        {
            return this.Equals(input as ContentSearchHelpArticles200Response);
        }

        /// <summary>
        /// Returns true if ContentSearchHelpArticles200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ContentSearchHelpArticles200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentSearchHelpArticles200Response input)
        {
            if (input == null)
            {
                return false;
