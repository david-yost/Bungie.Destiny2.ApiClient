...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Components.Vendors.DestinyVendorBaseComponent")]
    public partial class DestinyComponentsVendorsDestinyVendorBaseComponent : IEquatable<DestinyComponentsVendorsDestinyVendorBaseComponent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DestinyComponentsVendorsDestinyVendorBaseComponent" /> class.
        /// </summary>
        ...
        public DestinyComponentsVendorsDestinyVendorBaseComponent(int vendorHash = default(int), DateTime nextRefreshDate = default(DateTime), bool enabled = default(bool))
        {
        ...
        {
            return this.Equals(input as DestinyComponentsVendorsDestinyVendorBaseComponent);
        }

        /// <summary>
        /// Returns true if DestinyComponentsVendorsDestinyVendorBaseComponent instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyComponentsVendorsDestinyVendorBaseComponent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyComponentsVendorsDestinyVendorBaseComponent input)
        {
            if (input == null)
            {
                return false;
