...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.Seasons.DestinySeasonPassDefinition")]
    public partial class DestinyDefinitionsSeasonsDestinySeasonPassDefinition : IEquatable<DestinyDefinitionsSeasonsDestinySeasonPassDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DestinyDefinitionsSeasonsDestinySeasonPassDefinition);
        }

        /// <summary>
        /// Returns true if DestinyDefinitionsSeasonsDestinySeasonPassDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyDefinitionsSeasonsDestinySeasonPassDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyDefinitionsSeasonsDestinySeasonPassDefinition input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RewardProgressionHash == input.RewardProgressionHash ||
                    this.RewardProgressionHash.Equals(input.RewardProgressionHash)
                ) && 
                (
                    this.PrestigeProgressionHash == input.PrestigeProgressionHash ||
                    this.PrestigeProgressionHash.Equals(input.PrestigeProgressionHash)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RewardProgressionHash.GetHashCode();
                hashCode = (hashCode * 59) + this.PrestigeProgressionHash.GetHashCode();
