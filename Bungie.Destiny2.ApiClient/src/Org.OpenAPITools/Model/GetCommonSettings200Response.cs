...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_GetCommonSettings_200_response")]
    public partial class GetCommonSettings200Response : IEquatable<GetCommonSettings200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCommonSettings200Response" /> class.
        /// </summary>
        ...
        public GetCommonSettings200Response(CommonModelsCoreSettingsConfiguration response = default(CommonModelsCoreSettingsConfiguration), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public CommonModelsCoreSettingsConfiguration Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCommonSettings200Response {\n");
        ...
        {
            return this.Equals(input as GetCommonSettings200Response);
        }

        /// <summary>
        /// Returns true if GetCommonSettings200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCommonSettings200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCommonSettings200Response input)
        {
            if (input == null)
            {
                return false;
