...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_GetMembershipFromHardLinkedCredential_200_response")]
    public partial class UserGetMembershipFromHardLinkedCredential200Response : IEquatable<UserGetMembershipFromHardLinkedCredential200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetMembershipFromHardLinkedCredential200Response" /> class.
        /// </summary>
        ...
        public UserHardLinkedUserMembership Response { get; set; }
        ...
        {
            return this.Equals(input as UserGetMembershipFromHardLinkedCredential200Response);
        }

        /// <summary>
        /// Returns true if UserGetMembershipFromHardLinkedCredential200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGetMembershipFromHardLinkedCredential200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGetMembershipFromHardLinkedCredential200Response input)
        {
            if (input == null)
            {
                return false;
