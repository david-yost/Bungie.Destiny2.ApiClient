...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfGroupPotentialMembership")]
    public partial class SearchResultOfGroupPotentialMembership : IEquatable<SearchResultOfGroupPotentialMembership>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchResultOfGroupPotentialMembership {\n");
        ...
        {
            return this.Equals(input as SearchResultOfGroupPotentialMembership);
        }

        /// <summary>
        /// Returns true if SearchResultOfGroupPotentialMembership instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfGroupPotentialMembership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfGroupPotentialMembership input)
        {
            if (input == null)
            {
                return false;
