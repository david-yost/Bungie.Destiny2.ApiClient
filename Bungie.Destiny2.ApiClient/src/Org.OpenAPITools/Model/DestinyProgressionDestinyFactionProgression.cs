...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Progression.DestinyFactionProgression")]
    public partial class DestinyProgressionDestinyFactionProgression : IEquatable<DestinyProgressionDestinyFactionProgression>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DestinyProgressionDestinyFactionProgression);
        }

        /// <summary>
        /// Returns true if DestinyProgressionDestinyFactionProgression instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyProgressionDestinyFactionProgression to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyProgressionDestinyFactionProgression input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.FactionVendorIndex == input.FactionVendorIndex ||
                    this.FactionVendorIndex.Equals(input.FactionVendorIndex)
                ) && 
                (
