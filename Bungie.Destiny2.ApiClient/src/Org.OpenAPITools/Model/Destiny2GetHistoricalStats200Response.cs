...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetHistoricalStats_200_response")]
    public partial class Destiny2GetHistoricalStats200Response : IEquatable<Destiny2GetHistoricalStats200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetHistoricalStats200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetHistoricalStats200Response(Dictionary<string, DestinyHistoricalStatsDestinyHistoricalStatsByPeriod> response = default(Dictionary<string, DestinyHistoricalStatsDestinyHistoricalStatsByPeriod>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetHistoricalStats200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetHistoricalStats200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetHistoricalStats200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetHistoricalStats200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetHistoricalStats200Response input)
        {
            if (input == null)
            {
                return false;
