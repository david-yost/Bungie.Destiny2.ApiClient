...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyInventoryItemStatDefinition")]
    public partial class DestinyDefinitionsDestinyInventoryItemStatDefinition : IEquatable<DestinyDefinitionsDestinyInventoryItemStatDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyInventoryItemStatDefinition(int statHash = default(int), int value = default(int), int minimum = default(int), int maximum = default(int), int? displayMaximum = default(int?))
        {
        ...
        [DataMember(Name = "displayMaximum", EmitDefaultValue = true)]
