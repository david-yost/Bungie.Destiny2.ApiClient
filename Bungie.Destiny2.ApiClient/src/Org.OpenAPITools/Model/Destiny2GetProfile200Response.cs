...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetProfile_200_response")]
    public partial class Destiny2GetProfile200Response : IEquatable<Destiny2GetProfile200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetProfile200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetProfile200Response(DestinyResponsesDestinyProfileResponse response = default(DestinyResponsesDestinyProfileResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyResponsesDestinyProfileResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetProfile200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetProfile200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetProfile200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetProfile200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetProfile200Response input)
        {
            if (input == null)
            {
                return false;
