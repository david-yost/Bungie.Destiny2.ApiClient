...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Social_GetFriendRequestList_200_response")]
    public partial class SocialGetFriendRequestList200Response : IEquatable<SocialGetFriendRequestList200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SocialGetFriendRequestList200Response" /> class.
        /// </summary>
        ...
        public SocialGetFriendRequestList200Response(SocialFriendsBungieFriendRequestListResponse response = default(SocialFriendsBungieFriendRequestListResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public SocialFriendsBungieFriendRequestListResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SocialGetFriendRequestList200Response {\n");
        ...
        {
            return this.Equals(input as SocialGetFriendRequestList200Response);
        }

        /// <summary>
        /// Returns true if SocialGetFriendRequestList200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of SocialGetFriendRequestList200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialGetFriendRequestList200Response input)
        {
            if (input == null)
            {
                return false;
