...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_SearchByGlobalNamePrefix_200_response")]
    public partial class UserSearchByGlobalNamePrefix200Response : IEquatable<UserSearchByGlobalNamePrefix200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSearchByGlobalNamePrefix200Response" /> class.
        /// </summary>
        ...
        public UserSearchByGlobalNamePrefix200Response(UserUserSearchResponse response = default(UserUserSearchResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public UserUserSearchResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserSearchByGlobalNamePrefix200Response {\n");
        ...
        {
            return this.Equals(input as UserSearchByGlobalNamePrefix200Response);
        }

        /// <summary>
        /// Returns true if UserSearchByGlobalNamePrefix200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserSearchByGlobalNamePrefix200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserSearchByGlobalNamePrefix200Response input)
        {
            if (input == null)
            {
                return false;
