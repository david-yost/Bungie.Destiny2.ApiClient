...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SingleComponentResponseOfDestinyPlugSetsComponent")]
    public partial class SingleComponentResponseOfDestinyPlugSetsComponent : IEquatable<SingleComponentResponseOfDestinyPlugSetsComponent>, IValidatableObject
    {
        ...
        public SingleComponentResponseOfDestinyPlugSetsComponent(DestinyComponentsPlugSetsDestinyPlugSetsComponent data = default(DestinyComponentsPlugSetsDestinyPlugSetsComponent), int privacy = default(int), bool? disabled = default(bool?))
        {
            this.Data = data;
