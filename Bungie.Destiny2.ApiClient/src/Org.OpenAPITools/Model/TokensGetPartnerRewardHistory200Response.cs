...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tokens_GetPartnerRewardHistory_200_response")]
    public partial class TokensGetPartnerRewardHistory200Response : IEquatable<TokensGetPartnerRewardHistory200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensGetPartnerRewardHistory200Response" /> class.
        /// </summary>
        ...
        public TokensGetPartnerRewardHistory200Response(TokensPartnerRewardHistoryResponse response = default(TokensPartnerRewardHistoryResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public TokensPartnerRewardHistoryResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokensGetPartnerRewardHistory200Response {\n");
        ...
        {
            return this.Equals(input as TokensGetPartnerRewardHistory200Response);
        }

        /// <summary>
        /// Returns true if TokensGetPartnerRewardHistory200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TokensGetPartnerRewardHistory200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokensGetPartnerRewardHistory200Response input)
        {
            if (input == null)
            {
                return false;
