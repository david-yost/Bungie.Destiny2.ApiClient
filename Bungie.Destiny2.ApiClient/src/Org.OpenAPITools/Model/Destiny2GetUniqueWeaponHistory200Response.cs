...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetUniqueWeaponHistory_200_response")]
    public partial class Destiny2GetUniqueWeaponHistory200Response : IEquatable<Destiny2GetUniqueWeaponHistory200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetUniqueWeaponHistory200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetUniqueWeaponHistory200Response(DestinyHistoricalStatsDestinyHistoricalWeaponStatsData response = default(DestinyHistoricalStatsDestinyHistoricalWeaponStatsData), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyHistoricalStatsDestinyHistoricalWeaponStatsData Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetUniqueWeaponHistory200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetUniqueWeaponHistory200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetUniqueWeaponHistory200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetUniqueWeaponHistory200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetUniqueWeaponHistory200Response input)
        {
            if (input == null)
            {
                return false;
