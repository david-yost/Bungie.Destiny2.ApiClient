...
{
    /// <summary>
    /// GroupV2GetMembersOfGroup200Response
    /// </summary>
    [DataContract(Name = "GroupV2_GetMembersOfGroup_200_response")]
    public partial class GroupV2GetMembersOfGroup200Response : IEquatable<GroupV2GetMembersOfGroup200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2GetMembersOfGroup200Response" /> class.
        /// </summary>
        ...
        public GroupV2GetMembersOfGroup200Response(SearchResultOfGroupMember response = default(SearchResultOfGroupMember), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2GetMembersOfGroup200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2GetMembersOfGroup200Response);
        }

        /// <summary>
        /// Returns true if GroupV2GetMembersOfGroup200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2GetMembersOfGroup200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2GetMembersOfGroup200Response input)
        {
            if (input == null)
            {
                return false;
