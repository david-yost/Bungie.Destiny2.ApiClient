...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.Metrics.DestinyMetricDefinition")]
    public partial class DestinyDefinitionsMetricsDestinyMetricDefinition : IEquatable<DestinyDefinitionsMetricsDestinyMetricDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsMetricsDestinyMetricDefinition(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition displayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), int trackingObjectiveHash = default(int), bool lowerValueIsBetter = default(bool), int presentationNodeType = default(int), List<string> traitIds = default(List<string>), List<int> traitHashes = default(List<int>), List<int> parentNodeHashes = default(List<int>), int hash = default(int), int index = default(int), bool redacted = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "lowerValueIsBetter", EmitDefaultValue = true)]
