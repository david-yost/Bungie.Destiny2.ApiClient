...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Trending.TrendingEntryNews")]
    public partial class TrendingTrendingEntryNews : IEquatable<TrendingTrendingEntryNews>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TrendingTrendingEntryNews);
        }

        /// <summary>
        /// Returns true if TrendingTrendingEntryNews instances are equal
        /// </summary>
        /// <param name="input">Instance of TrendingTrendingEntryNews to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrendingTrendingEntryNews input)
        {
            if (input == null)
            {
                return false;
