...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetClanAggregateStats_200_response")]
    public partial class Destiny2GetClanAggregateStats200Response : IEquatable<Destiny2GetClanAggregateStats200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetClanAggregateStats200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetClanAggregateStats200Response(List<DestinyHistoricalStatsDestinyClanAggregateStat> response = default(List<DestinyHistoricalStatsDestinyClanAggregateStat>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<DestinyHistoricalStatsDestinyClanAggregateStat> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetClanAggregateStats200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetClanAggregateStats200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetClanAggregateStats200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetClanAggregateStats200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetClanAggregateStats200Response input)
        {
            if (input == null)
            {
                return false;
