...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetPublicMilestones_200_response")]
    public partial class Destiny2GetPublicMilestones200Response : IEquatable<Destiny2GetPublicMilestones200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetPublicMilestones200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetPublicMilestones200Response(Dictionary<string, DestinyMilestonesDestinyPublicMilestone> response = default(Dictionary<string, DestinyMilestonesDestinyPublicMilestone>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public Dictionary<string, DestinyMilestonesDestinyPublicMilestone> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetPublicMilestones200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetPublicMilestones200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetPublicMilestones200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetPublicMilestones200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetPublicMilestones200Response input)
        {
            if (input == null)
            {
                return false;
