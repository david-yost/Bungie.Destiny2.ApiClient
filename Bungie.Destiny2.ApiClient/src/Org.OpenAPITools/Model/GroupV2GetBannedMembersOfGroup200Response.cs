...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupV2_GetBannedMembersOfGroup_200_response")]
    public partial class GroupV2GetBannedMembersOfGroup200Response : IEquatable<GroupV2GetBannedMembersOfGroup200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2GetBannedMembersOfGroup200Response" /> class.
        /// </summary>
        ...
        public GroupV2GetBannedMembersOfGroup200Response(SearchResultOfGroupBan response = default(SearchResultOfGroupBan), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2GetBannedMembersOfGroup200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2GetBannedMembersOfGroup200Response);
        }

        /// <summary>
        /// Returns true if GroupV2GetBannedMembersOfGroup200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2GetBannedMembersOfGroup200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2GetBannedMembersOfGroup200Response input)
        {
            if (input == null)
            {
                return false;
