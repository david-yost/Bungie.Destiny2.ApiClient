...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetClanWeeklyRewardState_200_response")]
    public partial class Destiny2GetClanWeeklyRewardState200Response : IEquatable<Destiny2GetClanWeeklyRewardState200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetClanWeeklyRewardState200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetClanWeeklyRewardState200Response(DestinyMilestonesDestinyMilestone response = default(DestinyMilestonesDestinyMilestone), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyMilestonesDestinyMilestone Response { get; set; }
        ...
        {
            return this.Equals(input as Destiny2GetClanWeeklyRewardState200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetClanWeeklyRewardState200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetClanWeeklyRewardState200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetClanWeeklyRewardState200Response input)
        {
            if (input == null)
            {
                return false;
