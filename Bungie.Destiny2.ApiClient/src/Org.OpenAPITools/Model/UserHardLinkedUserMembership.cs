...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User.HardLinkedUserMembership")]
    public partial class UserHardLinkedUserMembership : IEquatable<UserHardLinkedUserMembership>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "CrossSaveOverriddenMembershipId", EmitDefaultValue = true)]
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CrossSaveOverriddenMembershipId != null)
                {
