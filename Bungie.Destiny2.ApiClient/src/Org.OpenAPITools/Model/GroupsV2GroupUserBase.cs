...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GroupUserBase")]
    public partial class GroupsV2GroupUserBase : IEquatable<GroupsV2GroupUserBase>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GroupsV2GroupUserBase);
        }

        /// <summary>
        /// Returns true if GroupsV2GroupUserBase instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsV2GroupUserBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsV2GroupUserBase input)
        {
            if (input == null)
            {
                return false;
