...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_GetGlobalAlerts_200_response")]
    public partial class GetGlobalAlerts200Response : IEquatable<GetGlobalAlerts200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGlobalAlerts200Response" /> class.
        /// </summary>
        ...
        public GetGlobalAlerts200Response(List<GlobalAlert> response = default(List<GlobalAlert>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<GlobalAlert> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetGlobalAlerts200Response {\n");
        ...
        {
            return this.Equals(input as GetGlobalAlerts200Response);
        }

        /// <summary>
        /// Returns true if GetGlobalAlerts200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetGlobalAlerts200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetGlobalAlerts200Response input)
        {
            if (input == null)
            {
                return false;
