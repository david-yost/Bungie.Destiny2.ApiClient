...
{
    /// <summary>
    /// GroupV2GetPendingMemberships200Response
    /// </summary>
    [DataContract(Name = "GroupV2_GetPendingMemberships_200_response")]
    public partial class GroupV2GetPendingMemberships200Response : IEquatable<GroupV2GetPendingMemberships200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2GetPendingMemberships200Response" /> class.
        /// </summary>
        ...
        public GroupV2GetPendingMemberships200Response(SearchResultOfGroupMemberApplication response = default(SearchResultOfGroupMemberApplication), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2GetPendingMemberships200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2GetPendingMemberships200Response);
        }

        /// <summary>
        /// Returns true if GroupV2GetPendingMemberships200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2GetPendingMemberships200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2GetPendingMemberships200Response input)
        {
            if (input == null)
            {
                return false;
