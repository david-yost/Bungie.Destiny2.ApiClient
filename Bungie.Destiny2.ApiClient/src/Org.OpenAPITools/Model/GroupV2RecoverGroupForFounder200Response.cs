...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupV2_RecoverGroupForFounder_200_response")]
    public partial class GroupV2RecoverGroupForFounder200Response : IEquatable<GroupV2RecoverGroupForFounder200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2RecoverGroupForFounder200Response" /> class.
        /// </summary>
        ...
        public GroupV2RecoverGroupForFounder200Response(GroupsV2GroupMembershipSearchResponse response = default(GroupsV2GroupMembershipSearchResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public GroupsV2GroupMembershipSearchResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2RecoverGroupForFounder200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2RecoverGroupForFounder200Response);
        }

        /// <summary>
        /// Returns true if GroupV2RecoverGroupForFounder200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2RecoverGroupForFounder200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2RecoverGroupForFounder200Response input)
        {
            if (input == null)
            {
                return false;
