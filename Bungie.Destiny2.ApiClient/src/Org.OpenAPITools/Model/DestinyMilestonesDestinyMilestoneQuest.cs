...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Milestones.DestinyMilestoneQuest")]
    public partial class DestinyMilestonesDestinyMilestoneQuest : IEquatable<DestinyMilestonesDestinyMilestoneQuest>, IValidatableObject
    {
        ...
        public DestinyMilestonesDestinyMilestoneQuest(int questItemHash = default(int), DestinyQuestsDestinyQuestStatus status = default(DestinyQuestsDestinyQuestStatus), DestinyMilestonesDestinyMilestoneActivity activity = default(DestinyMilestonesDestinyMilestoneActivity), List<DestinyChallengesDestinyChallengeStatus> challenges = default(List<DestinyChallengesDestinyChallengeStatus>))
        {
