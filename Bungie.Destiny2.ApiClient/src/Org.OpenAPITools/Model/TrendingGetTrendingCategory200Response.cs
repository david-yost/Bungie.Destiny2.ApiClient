...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Trending_GetTrendingCategory_200_response")]
    public partial class TrendingGetTrendingCategory200Response : IEquatable<TrendingGetTrendingCategory200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrendingGetTrendingCategory200Response" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TrendingGetTrendingCategory200Response);
        }

        /// <summary>
        /// Returns true if TrendingGetTrendingCategory200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrendingGetTrendingCategory200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrendingGetTrendingCategory200Response input)
        {
            if (input == null)
            {
                return false;
