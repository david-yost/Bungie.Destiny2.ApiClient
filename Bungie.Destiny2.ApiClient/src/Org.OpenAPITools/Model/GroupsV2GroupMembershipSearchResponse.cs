...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GroupMembershipSearchResponse")]
    public partial class GroupsV2GroupMembershipSearchResponse : IEquatable<GroupsV2GroupMembershipSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupsV2GroupMembershipSearchResponse" /> class.
        /// </summary>
        ...
        public GroupsV2GroupMembershipSearchResponse(List<GroupsV2GroupMembership> results = default(List<GroupsV2GroupMembership>), int totalResults = default(int), bool hasMore = default(bool), QueriesPagedQuery query = default(QueriesPagedQuery), string replacementContinuationToken = default(string), bool useTotalResults = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupsV2GroupMembershipSearchResponse {\n");
        ...
        {
            return this.Equals(input as GroupsV2GroupMembershipSearchResponse);
        }

        /// <summary>
        /// Returns true if GroupsV2GroupMembershipSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsV2GroupMembershipSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsV2GroupMembershipSearchResponse input)
        {
            if (input == null)
            {
                return false;
