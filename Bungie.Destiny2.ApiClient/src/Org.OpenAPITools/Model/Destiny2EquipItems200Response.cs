...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_EquipItems_200_response")]
    public partial class Destiny2EquipItems200Response : IEquatable<Destiny2EquipItems200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2EquipItems200Response" /> class.
        /// </summary>
        ...
        public Destiny2EquipItems200Response(DestinyDestinyEquipItemResults response = default(DestinyDestinyEquipItemResults), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyDestinyEquipItemResults Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2EquipItems200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2EquipItems200Response);
        }

        /// <summary>
        /// Returns true if Destiny2EquipItems200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2EquipItems200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2EquipItems200Response input)
        {
            if (input == null)
            {
                return false;
