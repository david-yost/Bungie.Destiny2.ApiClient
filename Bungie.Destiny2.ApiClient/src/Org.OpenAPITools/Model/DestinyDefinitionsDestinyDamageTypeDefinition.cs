...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyDamageTypeDefinition")]
    public partial class DestinyDefinitionsDestinyDamageTypeDefinition : IEquatable<DestinyDefinitionsDestinyDamageTypeDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyDamageTypeDefinition(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition displayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), string transparentIconPath = default(string), bool showIcon = default(bool), int enumValue = default(int), DestinyMiscDestinyColor color = default(DestinyMiscDestinyColor), int hash = default(int), int index = default(int), bool redacted = default(bool))
        {
