...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GroupMemberApplication")]
    public partial class GroupsV2GroupMemberApplication : IEquatable<GroupsV2GroupMemberApplication>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "resolveDate", EmitDefaultValue = true)]
        public DateTime? ResolveDate { get; set; }

        /// <summary>
        /// Gets or Sets ResolvedByMembershipId
        /// </summary>
        [DataMember(Name = "resolvedByMembershipId", EmitDefaultValue = true)]
