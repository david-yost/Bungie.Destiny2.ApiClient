...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_GetBungieNetUserById_200_response")]
    public partial class UserGetBungieNetUserById200Response : IEquatable<UserGetBungieNetUserById200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetBungieNetUserById200Response" /> class.
        /// </summary>
        ...
        public UserGetBungieNetUserById200Response(UserGeneralUser response = default(UserGeneralUser), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public UserGeneralUser Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetBungieNetUserById200Response {\n");
        ...
        {
            return this.Equals(input as UserGetBungieNetUserById200Response);
        }

        /// <summary>
        /// Returns true if UserGetBungieNetUserById200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGetBungieNetUserById200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGetBungieNetUserById200Response input)
        {
            if (input == null)
            {
                return false;
