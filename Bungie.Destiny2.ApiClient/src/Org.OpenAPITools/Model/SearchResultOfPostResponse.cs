...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfPostResponse")]
    public partial class SearchResultOfPostResponse : IEquatable<SearchResultOfPostResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchResultOfPostResponse {\n");
        ...
        {
            return this.Equals(input as SearchResultOfPostResponse);
        }

        /// <summary>
        /// Returns true if SearchResultOfPostResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfPostResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfPostResponse input)
        {
            if (input == null)
            {
                return false;
