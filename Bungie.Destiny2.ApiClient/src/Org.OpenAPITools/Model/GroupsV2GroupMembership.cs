...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GroupMembership")]
    public partial class GroupsV2GroupMembership : IEquatable<GroupsV2GroupMembership>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GroupsV2GroupMembership);
        }

        /// <summary>
        /// Returns true if GroupsV2GroupMembership instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsV2GroupMembership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsV2GroupMembership input)
        {
            if (input == null)
            {
                return false;
