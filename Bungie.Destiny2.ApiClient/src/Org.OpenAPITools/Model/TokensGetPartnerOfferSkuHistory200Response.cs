...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Tokens_GetPartnerOfferSkuHistory_200_response")]
    public partial class TokensGetPartnerOfferSkuHistory200Response : IEquatable<TokensGetPartnerOfferSkuHistory200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokensGetPartnerOfferSkuHistory200Response" /> class.
        /// </summary>
        ...
        public List<TokensPartnerOfferSkuHistoryResponse> Response { get; set; }
        ...
        {
            return this.Equals(input as TokensGetPartnerOfferSkuHistory200Response);
        }

        /// <summary>
        /// Returns true if TokensGetPartnerOfferSkuHistory200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TokensGetPartnerOfferSkuHistory200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokensGetPartnerOfferSkuHistory200Response input)
        {
            if (input == null)
            {
                return false;
