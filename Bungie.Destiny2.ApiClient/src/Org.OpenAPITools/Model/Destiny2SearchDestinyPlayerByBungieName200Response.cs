...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_SearchDestinyPlayerByBungieName_200_response")]
    public partial class Destiny2SearchDestinyPlayerByBungieName200Response : IEquatable<Destiny2SearchDestinyPlayerByBungieName200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2SearchDestinyPlayerByBungieName200Response" /> class.
        /// </summary>
        ...
        public Destiny2SearchDestinyPlayerByBungieName200Response(List<UserUserInfoCard> response = default(List<UserUserInfoCard>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<UserUserInfoCard> Response { get; set; }
        ...
        {
            return this.Equals(input as Destiny2SearchDestinyPlayerByBungieName200Response);
        }

        /// <summary>
        /// Returns true if Destiny2SearchDestinyPlayerByBungieName200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2SearchDestinyPlayerByBungieName200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2SearchDestinyPlayerByBungieName200Response input)
        {
            if (input == null)
            {
                return false;
