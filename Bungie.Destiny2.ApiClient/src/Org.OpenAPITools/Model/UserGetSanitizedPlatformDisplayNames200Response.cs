...
{
    /// <summary>
    /// UserGetSanitizedPlatformDisplayNames200Response
    /// </summary>
    [DataContract(Name = "User_GetSanitizedPlatformDisplayNames_200_response")]
    public partial class UserGetSanitizedPlatformDisplayNames200Response : IEquatable<UserGetSanitizedPlatformDisplayNames200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetSanitizedPlatformDisplayNames200Response" /> class.
        /// </summary>
        ...
        public UserGetSanitizedPlatformDisplayNames200Response(Dictionary<string, string> response = default(Dictionary<string, string>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetSanitizedPlatformDisplayNames200Response {\n");
        ...
        {
            return this.Equals(input as UserGetSanitizedPlatformDisplayNames200Response);
        }

        /// <summary>
        /// Returns true if UserGetSanitizedPlatformDisplayNames200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGetSanitizedPlatformDisplayNames200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGetSanitizedPlatformDisplayNames200Response input)
        {
            if (input == null)
            {
                return false;
