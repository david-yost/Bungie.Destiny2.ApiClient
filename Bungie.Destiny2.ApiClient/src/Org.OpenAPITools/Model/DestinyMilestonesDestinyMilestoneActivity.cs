...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Milestones.DestinyMilestoneActivity")]
    public partial class DestinyMilestonesDestinyMilestoneActivity : IEquatable<DestinyMilestonesDestinyMilestoneActivity>, IValidatableObject
    {
        ...
        public DestinyMilestonesDestinyMilestoneActivity(int activityHash = default(int), int? activityModeHash = default(int?), ActivityModeTypeEnum? activityModeType = default(ActivityModeTypeEnum?), List<int> modifierHashes = default(List<int>), List<DestinyMilestonesDestinyMilestoneActivityVariant> variants = default(List<DestinyMilestonesDestinyMilestoneActivityVariant>))
        {
