...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfFireteamResponse")]
    public partial class SearchResultOfFireteamResponse : IEquatable<SearchResultOfFireteamResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchResultOfFireteamResponse" /> class.
        /// </summary>
        ...
        public List<FireteamFireteamResponse> Results { get; set; }
        ...
        {
            return this.Equals(input as SearchResultOfFireteamResponse);
        }

        /// <summary>
        /// Returns true if SearchResultOfFireteamResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfFireteamResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfFireteamResponse input)
        {
            if (input == null)
            {
                return false;
