...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyVendorDefinition")]
    public partial class DestinyDefinitionsDestinyVendorDefinition : IEquatable<DestinyDefinitionsDestinyVendorDefinition>, IValidatableObject
    {
        ...
        /// <param name="vendorProgressionType">The type of reward progression that this vendor has. Default - The original rank progression from token redemption. Ritual - Progression from ranks in ritual content. For example: Crucible (Shaxx), Gambit (Drifter), and Battlegrounds (War Table)..</param>
        ...
        /// </summary>
        /// <value>The type of reward progression that this vendor has. Default - The original rank progression from token redemption. Ritual - Progression from ranks in ritual content. For example: Crucible (Shaxx), Gambit (Drifter), and Battlegrounds (War Table).</value>
        [DataMember(Name = "vendorProgressionType", EmitDefaultValue = false)]
        public int VendorProgressionType { get; set; }
        ...
        [DataMember(Name = "inhibitBuying", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "inhibitSelling", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "consolidateCategories", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "returnWithVendorRequest", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VendorProgressionType: ").Append(VendorProgressionType).Append("\n");
        ...
        public bool Equals(DestinyDefinitionsDestinyVendorDefinition input)
        {
            ...
            return 
                ...
                (
                    this.VendorProgressionType == input.VendorProgressionType ||
                    this.VendorProgressionType.Equals(input.VendorProgressionType)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.VendorProgressionType.GetHashCode();
