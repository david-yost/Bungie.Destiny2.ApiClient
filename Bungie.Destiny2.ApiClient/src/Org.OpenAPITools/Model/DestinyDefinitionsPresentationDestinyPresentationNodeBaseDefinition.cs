...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.Presentation.DestinyPresentationNodeBaseDefinition")]
    public partial class DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition : IEquatable<DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition" /> class.
        /// </summary>
        ...
        public DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition(int presentationNodeType = default(int), List<string> traitIds = default(List<string>), List<int> traitHashes = default(List<int>), List<int> parentNodeHashes = default(List<int>), int hash = default(int), int index = default(int), bool redacted = default(bool))
        {
        ...
        {
            return this.Equals(input as DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition);
        }

        /// <summary>
        /// Returns true if DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyDefinitionsPresentationDestinyPresentationNodeBaseDefinition input)
        {
            if (input == null)
            {
                return false;
