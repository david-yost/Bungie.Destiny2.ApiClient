...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_GetAvailableThemes_200_response")]
    public partial class UserGetAvailableThemes200Response : IEquatable<UserGetAvailableThemes200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetAvailableThemes200Response" /> class.
        /// </summary>
        ...
        public UserGetAvailableThemes200Response(List<ConfigUserTheme> response = default(List<ConfigUserTheme>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<ConfigUserTheme> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetAvailableThemes200Response {\n");
        ...
        {
            return this.Equals(input as UserGetAvailableThemes200Response);
        }

        /// <summary>
        /// Returns true if UserGetAvailableThemes200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGetAvailableThemes200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGetAvailableThemes200Response input)
        {
            if (input == null)
            {
                return false;
