...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetPublicVendors_200_response")]
    public partial class Destiny2GetPublicVendors200Response : IEquatable<Destiny2GetPublicVendors200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetPublicVendors200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetPublicVendors200Response(DestinyResponsesDestinyPublicVendorsResponse response = default(DestinyResponsesDestinyPublicVendorsResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyResponsesDestinyPublicVendorsResponse Response { get; set; }
        ...
        {
            return this.Equals(input as Destiny2GetPublicVendors200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetPublicVendors200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetPublicVendors200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetPublicVendors200Response input)
        {
            if (input == null)
            {
                return false;
