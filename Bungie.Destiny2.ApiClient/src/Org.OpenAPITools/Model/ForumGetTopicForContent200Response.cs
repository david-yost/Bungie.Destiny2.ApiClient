...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Forum_GetTopicForContent_200_response")]
    public partial class ForumGetTopicForContent200Response : IEquatable<ForumGetTopicForContent200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumGetTopicForContent200Response" /> class.
        /// </summary>
        ...
        public ForumGetTopicForContent200Response(long response = default(long), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        {
            return this.Equals(input as ForumGetTopicForContent200Response);
        }

        /// <summary>
        /// Returns true if ForumGetTopicForContent200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumGetTopicForContent200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumGetTopicForContent200Response input)
        {
            if (input == null)
            {
                return false;
