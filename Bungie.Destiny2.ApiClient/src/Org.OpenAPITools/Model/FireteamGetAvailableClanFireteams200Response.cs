...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Fireteam_GetAvailableClanFireteams_200_response")]
    public partial class FireteamGetAvailableClanFireteams200Response : IEquatable<FireteamGetAvailableClanFireteams200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FireteamGetAvailableClanFireteams200Response" /> class.
        /// </summary>
        ...
        public FireteamGetAvailableClanFireteams200Response(SearchResultOfFireteamSummary response = default(SearchResultOfFireteamSummary), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FireteamGetAvailableClanFireteams200Response {\n");
        ...
        {
            return this.Equals(input as FireteamGetAvailableClanFireteams200Response);
        }

        /// <summary>
        /// Returns true if FireteamGetAvailableClanFireteams200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of FireteamGetAvailableClanFireteams200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FireteamGetAvailableClanFireteams200Response input)
        {
            if (input == null)
            {
                return false;
