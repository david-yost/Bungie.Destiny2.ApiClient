...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyItemInventoryBlockDefinition")]
    public partial class DestinyDefinitionsDestinyItemInventoryBlockDefinition : IEquatable<DestinyDefinitionsDestinyItemInventoryBlockDefinition>, IValidatableObject
    {
        ...
        [DataMember(Name = "isInstanceItem", EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "suppressExpirationWhenObjectivesComplete", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>A reference to the associated crafting &#39;recipe&#39; item definition, if this item can be crafted.</value>
        [DataMember(Name = "recipeItemHash", EmitDefaultValue = true)]
        public int? RecipeItemHash { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecipeItemHash: ").Append(RecipeItemHash).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(DestinyDefinitionsDestinyItemInventoryBlockDefinition input)
        {
            ...
            return 
                ...
                (
                    this.RecipeItemHash == input.RecipeItemHash ||
                    (this.RecipeItemHash != null &&
                    this.RecipeItemHash.Equals(input.RecipeItemHash))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RecipeItemHash != null)
                {
                    hashCode = (hashCode * 59) + this.RecipeItemHash.GetHashCode();
                }
                return hashCode;
            }
        }
