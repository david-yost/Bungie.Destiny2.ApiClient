...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.DestinyActivity")]
    public partial class DestinyDestinyActivity : IEquatable<DestinyDestinyActivity>, IValidatableObject
    {
        ...
        public DestinyDestinyActivity(int activityHash = default(int), bool isNew = default(bool), bool canLead = default(bool), bool canJoin = default(bool), bool isCompleted = default(bool), bool isVisible = default(bool), int? displayLevel = default(int?), int? recommendedLight = default(int?), int difficultyTier = default(int), List<DestinyChallengesDestinyChallengeStatus> challenges = default(List<DestinyChallengesDestinyChallengeStatus>), List<int> modifierHashes = default(List<int>), Dictionary<string, bool> booleanActivityOptions = default(Dictionary<string, bool>), int? loadoutRequirementIndex = default(int?))
        {
        ...
        [DataMember(Name = "canLead", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "canJoin", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "displayLevel", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "recommendedLight", EmitDefaultValue = true)]
