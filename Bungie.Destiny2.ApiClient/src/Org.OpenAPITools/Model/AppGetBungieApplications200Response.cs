...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "App_GetBungieApplications_200_response")]
    public partial class AppGetBungieApplications200Response : IEquatable<AppGetBungieApplications200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppGetBungieApplications200Response" /> class.
        /// </summary>
        ...
        public AppGetBungieApplications200Response(List<ApplicationsApplication> response = default(List<ApplicationsApplication>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<ApplicationsApplication> Response { get; set; }
        ...
        {
            return this.Equals(input as AppGetBungieApplications200Response);
        }

        /// <summary>
        /// Returns true if AppGetBungieApplications200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of AppGetBungieApplications200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppGetBungieApplications200Response input)
        {
            if (input == null)
            {
                return false;
