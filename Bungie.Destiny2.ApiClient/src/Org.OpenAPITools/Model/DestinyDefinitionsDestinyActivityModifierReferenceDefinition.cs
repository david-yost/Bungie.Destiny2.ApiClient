...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyActivityModifierReferenceDefinition")]
    public partial class DestinyDefinitionsDestinyActivityModifierReferenceDefinition : IEquatable<DestinyDefinitionsDestinyActivityModifierReferenceDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DestinyDefinitionsDestinyActivityModifierReferenceDefinition);
        }

        /// <summary>
        /// Returns true if DestinyDefinitionsDestinyActivityModifierReferenceDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyDefinitionsDestinyActivityModifierReferenceDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyDefinitionsDestinyActivityModifierReferenceDefinition input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ActivityModifierHash == input.ActivityModifierHash ||
                    this.ActivityModifierHash.Equals(input.ActivityModifierHash)
                );
        }
