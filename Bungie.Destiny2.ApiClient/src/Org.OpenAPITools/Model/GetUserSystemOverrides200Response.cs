...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_GetUserSystemOverrides_200_response")]
    public partial class GetUserSystemOverrides200Response : IEquatable<GetUserSystemOverrides200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserSystemOverrides200Response" /> class.
        /// </summary>
        ...
        public GetUserSystemOverrides200Response(Dictionary<string, CommonModelsCoreSystem> response = default(Dictionary<string, CommonModelsCoreSystem>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public Dictionary<string, CommonModelsCoreSystem> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetUserSystemOverrides200Response {\n");
        ...
        {
            return this.Equals(input as GetUserSystemOverrides200Response);
        }

        /// <summary>
        /// Returns true if GetUserSystemOverrides200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserSystemOverrides200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserSystemOverrides200Response input)
        {
            if (input == null)
            {
                return false;
