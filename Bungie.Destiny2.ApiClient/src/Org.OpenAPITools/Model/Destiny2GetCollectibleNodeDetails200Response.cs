...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetCollectibleNodeDetails_200_response")]
    public partial class Destiny2GetCollectibleNodeDetails200Response : IEquatable<Destiny2GetCollectibleNodeDetails200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetCollectibleNodeDetails200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetCollectibleNodeDetails200Response(DestinyResponsesDestinyCollectibleNodeDetailResponse response = default(DestinyResponsesDestinyCollectibleNodeDetailResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyResponsesDestinyCollectibleNodeDetailResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetCollectibleNodeDetails200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetCollectibleNodeDetails200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetCollectibleNodeDetails200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetCollectibleNodeDetails200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetCollectibleNodeDetails200Response input)
        {
            if (input == null)
            {
                return false;
