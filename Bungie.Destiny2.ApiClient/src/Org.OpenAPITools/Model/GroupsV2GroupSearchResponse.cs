...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GroupSearchResponse")]
    public partial class GroupsV2GroupSearchResponse : IEquatable<GroupsV2GroupSearchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupsV2GroupSearchResponse {\n");
        ...
        {
            return this.Equals(input as GroupsV2GroupSearchResponse);
        }

        /// <summary>
        /// Returns true if GroupsV2GroupSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsV2GroupSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsV2GroupSearchResponse input)
        {
            if (input == null)
            {
                return false;
