...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetCharacter_200_response")]
    public partial class Destiny2GetCharacter200Response : IEquatable<Destiny2GetCharacter200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetCharacter200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetCharacter200Response(DestinyResponsesDestinyCharacterResponse response = default(DestinyResponsesDestinyCharacterResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyResponsesDestinyCharacterResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetCharacter200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetCharacter200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetCharacter200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetCharacter200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetCharacter200Response input)
        {
            if (input == null)
            {
                return false;
