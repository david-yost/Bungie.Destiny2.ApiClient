...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Social_GetFriendList_200_response")]
    public partial class SocialGetFriendList200Response : IEquatable<SocialGetFriendList200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SocialGetFriendList200Response" /> class.
        /// </summary>
        ...
        public SocialGetFriendList200Response(SocialFriendsBungieFriendListResponse response = default(SocialFriendsBungieFriendListResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public SocialFriendsBungieFriendListResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SocialGetFriendList200Response {\n");
        ...
        {
            return this.Equals(input as SocialGetFriendList200Response);
        }

        /// <summary>
        /// Returns true if SocialGetFriendList200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of SocialGetFriendList200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocialGetFriendList200Response input)
        {
            if (input == null)
            {
                return false;
