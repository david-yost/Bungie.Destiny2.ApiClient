...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Content.Models.ContentTypeDescription")]
    public partial class ContentModelsContentTypeDescription : IEquatable<ContentModelsContentTypeDescription>, IValidatableObject
    {
        ...
        /// <param name="varTypeOf">varTypeOf.</param>
        ...
        /// </summary>
        [DataMember(Name = "showInContentEditor", EmitDefaultValue = true)]
        public bool ShowInContentEditor { get; set; }

        /// <summary>
        /// Gets or Sets VarTypeOf
        /// </summary>
        [DataMember(Name = "typeOf", EmitDefaultValue = false)]
        public string VarTypeOf { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "forceIdentifierBinding", EmitDefaultValue = true)]
        public bool ForceIdentifierBinding { get; set; }

        /// <summary>
        /// Gets or Sets AllowComments
        /// </summary>
        [DataMember(Name = "allowComments", EmitDefaultValue = true)]
        public bool AllowComments { get; set; }

        /// <summary>
        /// Gets or Sets AutoEnglishPropertyFallback
        /// </summary>
        [DataMember(Name = "autoEnglishPropertyFallback", EmitDefaultValue = true)]
        public bool AutoEnglishPropertyFallback { get; set; }

        /// <summary>
        /// Gets or Sets BulkUploadable
        /// </summary>
        [DataMember(Name = "bulkUploadable", EmitDefaultValue = true)]
        ...
        /// </summary>
        [DataMember(Name = "suppressCmsPath", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarTypeOf: ").Append(VarTypeOf).Append("\n");
        ...
        public bool Equals(ContentModelsContentTypeDescription input)
        {
            ...
            return 
                ...
                (
                    this.VarTypeOf == input.VarTypeOf ||
                    (this.VarTypeOf != null &&
                    this.VarTypeOf.Equals(input.VarTypeOf))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VarTypeOf != null)
                {
                    hashCode = (hashCode * 59) + this.VarTypeOf.GetHashCode();
                }
