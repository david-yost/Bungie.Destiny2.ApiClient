...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupV2_IndividualGroupInvite_200_response")]
    public partial class GroupV2IndividualGroupInvite200Response : IEquatable<GroupV2IndividualGroupInvite200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2IndividualGroupInvite200Response" /> class.
        /// </summary>
        ...
        public GroupV2IndividualGroupInvite200Response(GroupsV2GroupApplicationResponse response = default(GroupsV2GroupApplicationResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public GroupsV2GroupApplicationResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2IndividualGroupInvite200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2IndividualGroupInvite200Response);
        }

        /// <summary>
        /// Returns true if GroupV2IndividualGroupInvite200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2IndividualGroupInvite200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2IndividualGroupInvite200Response input)
        {
            if (input == null)
            {
                return false;
