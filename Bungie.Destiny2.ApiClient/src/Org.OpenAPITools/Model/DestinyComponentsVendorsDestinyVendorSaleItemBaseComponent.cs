...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Components.Vendors.DestinyVendorSaleItemBaseComponent")]
    public partial class DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent : IEquatable<DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent);
        }

        /// <summary>
        /// Returns true if DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent input)
        {
            if (input == null)
            {
                return false;
