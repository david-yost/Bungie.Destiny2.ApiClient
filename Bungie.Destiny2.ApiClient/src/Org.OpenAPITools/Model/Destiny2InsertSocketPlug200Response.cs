...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_InsertSocketPlug_200_response")]
    public partial class Destiny2InsertSocketPlug200Response : IEquatable<Destiny2InsertSocketPlug200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2InsertSocketPlug200Response" /> class.
        /// </summary>
        ...
        public Destiny2InsertSocketPlug200Response(DestinyResponsesDestinyItemChangeResponse response = default(DestinyResponsesDestinyItemChangeResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyResponsesDestinyItemChangeResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2InsertSocketPlug200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2InsertSocketPlug200Response);
        }

        /// <summary>
        /// Returns true if Destiny2InsertSocketPlug200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2InsertSocketPlug200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2InsertSocketPlug200Response input)
        {
            if (input == null)
            {
                return false;
