...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetDestinyAggregateActivityStats_200_response")]
    public partial class Destiny2GetDestinyAggregateActivityStats200Response : IEquatable<Destiny2GetDestinyAggregateActivityStats200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetDestinyAggregateActivityStats200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetDestinyAggregateActivityStats200Response(DestinyHistoricalStatsDestinyAggregateActivityResults response = default(DestinyHistoricalStatsDestinyAggregateActivityResults), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyHistoricalStatsDestinyAggregateActivityResults Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetDestinyAggregateActivityStats200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetDestinyAggregateActivityStats200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetDestinyAggregateActivityStats200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetDestinyAggregateActivityStats200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetDestinyAggregateActivityStats200Response input)
        {
            if (input == null)
            {
                return false;
