...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Trending_GetTrendingEntryDetail_200_response")]
    public partial class TrendingGetTrendingEntryDetail200Response : IEquatable<TrendingGetTrendingEntryDetail200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrendingGetTrendingEntryDetail200Response" /> class.
        /// </summary>
        ...
        public TrendingGetTrendingEntryDetail200Response(TrendingTrendingDetail response = default(TrendingTrendingDetail), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public TrendingTrendingDetail Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrendingGetTrendingEntryDetail200Response {\n");
        ...
        {
            return this.Equals(input as TrendingGetTrendingEntryDetail200Response);
        }

        /// <summary>
        /// Returns true if TrendingGetTrendingEntryDetail200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of TrendingGetTrendingEntryDetail200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrendingGetTrendingEntryDetail200Response input)
        {
            if (input == null)
            {
                return false;
