...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetDestinyManifest_200_response")]
    public partial class Destiny2GetDestinyManifest200Response : IEquatable<Destiny2GetDestinyManifest200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetDestinyManifest200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetDestinyManifest200Response(DestinyConfigDestinyManifest response = default(DestinyConfigDestinyManifest), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyConfigDestinyManifest Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetDestinyManifest200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetDestinyManifest200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetDestinyManifest200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetDestinyManifest200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetDestinyManifest200Response input)
        {
            if (input == null)
            {
                return false;
