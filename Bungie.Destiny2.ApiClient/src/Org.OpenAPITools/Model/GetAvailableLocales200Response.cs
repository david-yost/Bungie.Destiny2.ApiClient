...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_GetAvailableLocales_200_response")]
    public partial class GetAvailableLocales200Response : IEquatable<GetAvailableLocales200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailableLocales200Response" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetAvailableLocales200Response);
        }

        /// <summary>
        /// Returns true if GetAvailableLocales200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAvailableLocales200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAvailableLocales200Response input)
        {
            if (input == null)
            {
                return false;
