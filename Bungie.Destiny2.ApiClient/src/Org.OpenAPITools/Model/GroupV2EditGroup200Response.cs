...
{
    /// <summary>
    /// GroupV2EditGroup200Response
    /// </summary>
    [DataContract(Name = "GroupV2_EditGroup_200_response")]
    public partial class GroupV2EditGroup200Response : IEquatable<GroupV2EditGroup200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2EditGroup200Response" /> class.
        /// </summary>
        ...
        public GroupV2EditGroup200Response(int response = default(int), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2EditGroup200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2EditGroup200Response);
        }

        /// <summary>
        /// Returns true if GroupV2EditGroup200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2EditGroup200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2EditGroup200Response input)
        {
            if (input == null)
            {
                return false;
