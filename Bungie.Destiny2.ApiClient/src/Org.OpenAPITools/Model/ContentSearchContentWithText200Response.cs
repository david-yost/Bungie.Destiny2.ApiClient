...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Content_SearchContentWithText_200_response")]
    public partial class ContentSearchContentWithText200Response : IEquatable<ContentSearchContentWithText200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentSearchContentWithText200Response" /> class.
        /// </summary>
        ...
        public ContentSearchContentWithText200Response(SearchResultOfContentItemPublicContract response = default(SearchResultOfContentItemPublicContract), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentSearchContentWithText200Response {\n");
        ...
        {
            return this.Equals(input as ContentSearchContentWithText200Response);
        }

        /// <summary>
        /// Returns true if ContentSearchContentWithText200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ContentSearchContentWithText200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentSearchContentWithText200Response input)
        {
            if (input == null)
            {
                return false;
