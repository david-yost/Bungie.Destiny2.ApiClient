...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Milestones.DestinyPublicMilestoneVendor")]
    public partial class DestinyMilestonesDestinyPublicMilestoneVendor : IEquatable<DestinyMilestonesDestinyPublicMilestoneVendor>, IValidatableObject
    {
        ...
        public DestinyMilestonesDestinyPublicMilestoneVendor(int vendorHash = default(int), int? previewItemHash = default(int?))
        {
