...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_SearchDestinyEntities_200_response")]
    public partial class Destiny2SearchDestinyEntities200Response : IEquatable<Destiny2SearchDestinyEntities200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2SearchDestinyEntities200Response" /> class.
        /// </summary>
        ...
        public DestinyDefinitionsDestinyEntitySearchResult Response { get; set; }
        ...
        {
            return this.Equals(input as Destiny2SearchDestinyEntities200Response);
        }

        /// <summary>
        /// Returns true if Destiny2SearchDestinyEntities200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2SearchDestinyEntities200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2SearchDestinyEntities200Response input)
        {
            if (input == null)
            {
                return false;
