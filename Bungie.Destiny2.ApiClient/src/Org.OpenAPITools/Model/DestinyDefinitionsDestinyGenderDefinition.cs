...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyGenderDefinition")]
    public partial class DestinyDefinitionsDestinyGenderDefinition : IEquatable<DestinyDefinitionsDestinyGenderDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyGenderDefinition(int genderType = default(int), DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition displayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), int hash = default(int), int index = default(int), bool redacted = default(bool))
        {
