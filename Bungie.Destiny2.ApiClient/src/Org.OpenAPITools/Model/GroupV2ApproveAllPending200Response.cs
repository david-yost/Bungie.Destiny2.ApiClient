...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupV2_ApproveAllPending_200_response")]
    public partial class GroupV2ApproveAllPending200Response : IEquatable<GroupV2ApproveAllPending200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2ApproveAllPending200Response" /> class.
        /// </summary>
        ...
        public List<EntitiesEntityActionResult> Response { get; set; }
        ...
        {
            return this.Equals(input as GroupV2ApproveAllPending200Response);
        }

        /// <summary>
        /// Returns true if GroupV2ApproveAllPending200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2ApproveAllPending200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2ApproveAllPending200Response input)
        {
            if (input == null)
            {
                return false;
