...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Milestones.DestinyPublicMilestoneQuest")]
    public partial class DestinyMilestonesDestinyPublicMilestoneQuest : IEquatable<DestinyMilestonesDestinyPublicMilestoneQuest>, IValidatableObject
    {
        ...
        public DestinyMilestonesDestinyPublicMilestoneQuest(int questItemHash = default(int), DestinyMilestonesDestinyPublicMilestoneActivity activity = default(DestinyMilestonesDestinyPublicMilestoneActivity), List<DestinyMilestonesDestinyPublicMilestoneChallenge> challenges = default(List<DestinyMilestonesDestinyPublicMilestoneChallenge>))
        {
