...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Fireteam_GetMyClanFireteams_200_response")]
    public partial class FireteamGetMyClanFireteams200Response : IEquatable<FireteamGetMyClanFireteams200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FireteamGetMyClanFireteams200Response" /> class.
        /// </summary>
        ...
        public FireteamGetMyClanFireteams200Response(SearchResultOfFireteamResponse response = default(SearchResultOfFireteamResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FireteamGetMyClanFireteams200Response {\n");
        ...
        {
            return this.Equals(input as FireteamGetMyClanFireteams200Response);
        }

        /// <summary>
        /// Returns true if FireteamGetMyClanFireteams200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of FireteamGetMyClanFireteams200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FireteamGetMyClanFireteams200Response input)
        {
            if (input == null)
            {
                return false;
