...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GroupPotentialMembershipSearchResponse")]
    public partial class GroupsV2GroupPotentialMembershipSearchResponse : IEquatable<GroupsV2GroupPotentialMembershipSearchResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public List<GroupsV2GroupPotentialMembership> Results { get; set; }
        ...
        {
            return this.Equals(input as GroupsV2GroupPotentialMembershipSearchResponse);
        }

        /// <summary>
        /// Returns true if GroupsV2GroupPotentialMembershipSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsV2GroupPotentialMembershipSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsV2GroupPotentialMembershipSearchResponse input)
        {
            if (input == null)
            {
                return false;
