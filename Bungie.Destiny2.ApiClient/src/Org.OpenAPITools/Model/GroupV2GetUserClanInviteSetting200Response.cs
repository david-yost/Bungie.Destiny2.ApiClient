...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupV2_GetUserClanInviteSetting_200_response")]
    public partial class GroupV2GetUserClanInviteSetting200Response : IEquatable<GroupV2GetUserClanInviteSetting200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2GetUserClanInviteSetting200Response" /> class.
        /// </summary>
        ...
        public GroupV2GetUserClanInviteSetting200Response(bool response = default(bool), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2GetUserClanInviteSetting200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2GetUserClanInviteSetting200Response);
        }

        /// <summary>
        /// Returns true if GroupV2GetUserClanInviteSetting200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2GetUserClanInviteSetting200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2GetUserClanInviteSetting200Response input)
        {
            if (input == null)
            {
                return false;
