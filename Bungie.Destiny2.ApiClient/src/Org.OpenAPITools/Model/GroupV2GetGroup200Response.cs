...
{
    /// <summary>
    /// GroupV2GetGroup200Response
    /// </summary>
    [DataContract(Name = "GroupV2_GetGroup_200_response")]
    public partial class GroupV2GetGroup200Response : IEquatable<GroupV2GetGroup200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2GetGroup200Response" /> class.
        /// </summary>
        ...
        public GroupV2GetGroup200Response(GroupsV2GroupResponse response = default(GroupsV2GroupResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public GroupsV2GroupResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2GetGroup200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2GetGroup200Response);
        }

        /// <summary>
        /// Returns true if GroupV2GetGroup200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2GetGroup200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2GetGroup200Response input)
        {
            if (input == null)
            {
                return false;
