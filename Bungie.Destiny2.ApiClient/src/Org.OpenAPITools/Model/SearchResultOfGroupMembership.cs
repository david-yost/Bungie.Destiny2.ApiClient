...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfGroupMembership")]
    public partial class SearchResultOfGroupMembership : IEquatable<SearchResultOfGroupMembership>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchResultOfGroupMembership" /> class.
        /// </summary>
        ...
        public SearchResultOfGroupMembership(List<GroupsV2GroupMembership> results = default(List<GroupsV2GroupMembership>), int totalResults = default(int), bool hasMore = default(bool), QueriesPagedQuery query = default(QueriesPagedQuery), string replacementContinuationToken = default(string), bool useTotalResults = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchResultOfGroupMembership {\n");
        ...
        {
            return this.Equals(input as SearchResultOfGroupMembership);
        }

        /// <summary>
        /// Returns true if SearchResultOfGroupMembership instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfGroupMembership to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfGroupMembership input)
        {
            if (input == null)
            {
                return false;
