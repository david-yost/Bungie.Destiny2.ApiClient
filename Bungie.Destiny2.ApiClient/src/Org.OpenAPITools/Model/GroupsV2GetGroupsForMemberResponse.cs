...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsV2.GetGroupsForMemberResponse")]
    public partial class GroupsV2GetGroupsForMemberResponse : IEquatable<GroupsV2GetGroupsForMemberResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>A convenience property that indicates if every membership this user has that is a part of this group are part of an account that is considered inactive - for example, overridden accounts in Cross Save.   The key is the Group ID for the group being checked, and the value is true if the users&#39; memberships for that group are all inactive.</value>
        ...
        public List<GroupsV2GroupMembership> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AreAllMembershipsInactive: ").Append(AreAllMembershipsInactive).Append("\n");
        ...
        {
            return this.Equals(input as GroupsV2GetGroupsForMemberResponse);
        }

        /// <summary>
        /// Returns true if GroupsV2GetGroupsForMemberResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsV2GetGroupsForMemberResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsV2GetGroupsForMemberResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AreAllMembershipsInactive == input.AreAllMembershipsInactive ||
                    this.AreAllMembershipsInactive != null &&
                    input.AreAllMembershipsInactive != null &&
                    this.AreAllMembershipsInactive.SequenceEqual(input.AreAllMembershipsInactive)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AreAllMembershipsInactive.GetHashCode();
                }
