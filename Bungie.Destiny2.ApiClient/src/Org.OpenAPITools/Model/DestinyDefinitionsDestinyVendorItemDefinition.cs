...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyVendorItemDefinition")]
    public partial class DestinyDefinitionsDestinyVendorItemDefinition : IEquatable<DestinyDefinitionsDestinyVendorItemDefinition>, IValidatableObject
    {
        ...
        [DataMember(Name = "isCrm", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>If true, this item is some sort of dummy sale item that cannot actually be purchased. It may be a display only item, or some fluff left by a content designer for testing purposes, or something that got disabled because it was a terrible idea. You get the picture. We won&#39;t know *why* it can&#39;t be purchased, only that it can&#39;t be. Sorry.  This is also only whether it&#39;s unpurchasable as a static property according to game content. There are other reasons why an item may or may not be purchasable at runtime, so even if this isn&#39;t set to True you should trust the runtime value for this sale item over the static definition if this is unset.</value>
        [DataMember(Name = "unpurchasable", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Unpurchasable: ").Append(Unpurchasable).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(DestinyDefinitionsDestinyVendorItemDefinition input)
        {
            ...
            return 
                ...
                (
                    this.Unpurchasable == input.Unpurchasable ||
                    (this.Unpurchasable != null &&
                    this.Unpurchasable.Equals(input.Unpurchasable))
                );
        }
