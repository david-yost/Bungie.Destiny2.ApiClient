...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "User_GetCredentialTypesForTargetAccount_200_response")]
    public partial class UserGetCredentialTypesForTargetAccount200Response : IEquatable<UserGetCredentialTypesForTargetAccount200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGetCredentialTypesForTargetAccount200Response" /> class.
        /// </summary>
        ...
        public UserGetCredentialTypesForTargetAccount200Response(List<UserModelsGetCredentialTypesForAccountResponse> response = default(List<UserModelsGetCredentialTypesForAccountResponse>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<UserModelsGetCredentialTypesForAccountResponse> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserGetCredentialTypesForTargetAccount200Response {\n");
        ...
        {
            return this.Equals(input as UserGetCredentialTypesForTargetAccount200Response);
        }

        /// <summary>
        /// Returns true if UserGetCredentialTypesForTargetAccount200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGetCredentialTypesForTargetAccount200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGetCredentialTypesForTargetAccount200Response input)
        {
            if (input == null)
            {
                return false;
