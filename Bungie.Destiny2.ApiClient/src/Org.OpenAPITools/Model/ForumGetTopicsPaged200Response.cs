...
{
    /// <summary>
    /// ForumGetTopicsPaged200Response
    /// </summary>
    [DataContract(Name = "Forum_GetTopicsPaged_200_response")]
    public partial class ForumGetTopicsPaged200Response : IEquatable<ForumGetTopicsPaged200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumGetTopicsPaged200Response" /> class.
        /// </summary>
        ...
        public ForumGetTopicsPaged200Response(ForumPostSearchResponse response = default(ForumPostSearchResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public ForumPostSearchResponse Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumGetTopicsPaged200Response {\n");
        ...
        {
            return this.Equals(input as ForumGetTopicsPaged200Response);
        }

        /// <summary>
        /// Returns true if ForumGetTopicsPaged200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumGetTopicsPaged200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumGetTopicsPaged200Response input)
        {
            if (input == null)
            {
                return false;
