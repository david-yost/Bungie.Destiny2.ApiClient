...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfTrendingEntry")]
    public partial class SearchResultOfTrendingEntry : IEquatable<SearchResultOfTrendingEntry>, IValidatableObject
    {
        /// <summary>
        ...
        public List<TrendingTrendingEntry> Results { get; set; }
        ...
        {
            return this.Equals(input as SearchResultOfTrendingEntry);
        }

        /// <summary>
        /// Returns true if SearchResultOfTrendingEntry instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfTrendingEntry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfTrendingEntry input)
        {
            if (input == null)
            {
                return false;
