...
namespace Org.OpenAPITools.Model
{
    ...
    /// QueriesSearchResult
    /// </summary>
    [DataContract(Name = "Queries.SearchResult")]
    public partial class QueriesSearchResult : IEquatable<QueriesSearchResult>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueriesSearchResult {\n");
        ...
        {
            return this.Equals(input as QueriesSearchResult);
        }

        /// <summary>
        /// Returns true if QueriesSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of QueriesSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueriesSearchResult input)
        {
            if (input == null)
            {
                return false;
