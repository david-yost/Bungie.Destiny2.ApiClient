...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny.Definitions.DestinyMaterialRequirementSetDefinition")]
    public partial class DestinyDefinitionsDestinyMaterialRequirementSetDefinition : IEquatable<DestinyDefinitionsDestinyMaterialRequirementSetDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyMaterialRequirementSetDefinition(List<DestinyDefinitionsDestinyMaterialRequirement> materials = default(List<DestinyDefinitionsDestinyMaterialRequirement>), int hash = default(int), int index = default(int), bool redacted = default(bool))
        {
