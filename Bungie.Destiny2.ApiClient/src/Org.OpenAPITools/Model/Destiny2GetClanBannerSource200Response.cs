...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetClanBannerSource_200_response")]
    public partial class Destiny2GetClanBannerSource200Response : IEquatable<Destiny2GetClanBannerSource200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetClanBannerSource200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetClanBannerSource200Response(Object response = default(Object), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        {
            return this.Equals(input as Destiny2GetClanBannerSource200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetClanBannerSource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetClanBannerSource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetClanBannerSource200Response input)
        {
            if (input == null)
            {
                return false;
