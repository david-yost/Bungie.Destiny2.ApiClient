...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Forum_GetRecruitmentThreadSummaries_200_response")]
    public partial class ForumGetRecruitmentThreadSummaries200Response : IEquatable<ForumGetRecruitmentThreadSummaries200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumGetRecruitmentThreadSummaries200Response" /> class.
        /// </summary>
        ...
        public ForumGetRecruitmentThreadSummaries200Response(List<ForumForumRecruitmentDetail> response = default(List<ForumForumRecruitmentDetail>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<ForumForumRecruitmentDetail> Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumGetRecruitmentThreadSummaries200Response {\n");
        ...
        {
            return this.Equals(input as ForumGetRecruitmentThreadSummaries200Response);
        }

        /// <summary>
        /// Returns true if ForumGetRecruitmentThreadSummaries200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumGetRecruitmentThreadSummaries200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumGetRecruitmentThreadSummaries200Response input)
        {
            if (input == null)
            {
                return false;
