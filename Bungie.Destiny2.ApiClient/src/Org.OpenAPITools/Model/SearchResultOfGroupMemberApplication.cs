...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfGroupMemberApplication")]
    public partial class SearchResultOfGroupMemberApplication : IEquatable<SearchResultOfGroupMemberApplication>, IValidatableObject
    {
        /// <summary>
        ...
        public List<GroupsV2GroupMemberApplication> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchResultOfGroupMemberApplication {\n");
        ...
        {
            return this.Equals(input as SearchResultOfGroupMemberApplication);
        }

        /// <summary>
        /// Returns true if SearchResultOfGroupMemberApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfGroupMemberApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfGroupMemberApplication input)
        {
            if (input == null)
            {
                return false;
