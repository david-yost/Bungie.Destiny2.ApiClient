...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupV2_KickMember_200_response")]
    public partial class GroupV2KickMember200Response : IEquatable<GroupV2KickMember200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupV2KickMember200Response" /> class.
        /// </summary>
        ...
        public GroupV2KickMember200Response(GroupsV2GroupMemberLeaveResult response = default(GroupsV2GroupMemberLeaveResult), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public GroupsV2GroupMemberLeaveResult Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupV2KickMember200Response {\n");
        ...
        {
            return this.Equals(input as GroupV2KickMember200Response);
        }

        /// <summary>
        /// Returns true if GroupV2KickMember200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupV2KickMember200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupV2KickMember200Response input)
        {
            if (input == null)
            {
                return false;
