...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchResultOfGroupBan")]
    public partial class SearchResultOfGroupBan : IEquatable<SearchResultOfGroupBan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchResultOfGroupBan" /> class.
        /// </summary>
        ...
        public SearchResultOfGroupBan(List<GroupsV2GroupBan> results = default(List<GroupsV2GroupBan>), int totalResults = default(int), bool hasMore = default(bool), QueriesPagedQuery query = default(QueriesPagedQuery), string replacementContinuationToken = default(string), bool useTotalResults = default(bool))
        {
        ...
        public List<GroupsV2GroupBan> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchResultOfGroupBan {\n");
        ...
        {
            return this.Equals(input as SearchResultOfGroupBan);
        }

        /// <summary>
        /// Returns true if SearchResultOfGroupBan instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfGroupBan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfGroupBan input)
        {
            if (input == null)
            {
                return false;
