...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetDestinyEntityDefinition_200_response")]
    public partial class Destiny2GetDestinyEntityDefinition200Response : IEquatable<Destiny2GetDestinyEntityDefinition200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetDestinyEntityDefinition200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetDestinyEntityDefinition200Response(DestinyDefinitionsDestinyDefinition response = default(DestinyDefinitionsDestinyDefinition), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public DestinyDefinitionsDestinyDefinition Response { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetDestinyEntityDefinition200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetDestinyEntityDefinition200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetDestinyEntityDefinition200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetDestinyEntityDefinition200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetDestinyEntityDefinition200Response input)
        {
            if (input == null)
            {
                return false;
