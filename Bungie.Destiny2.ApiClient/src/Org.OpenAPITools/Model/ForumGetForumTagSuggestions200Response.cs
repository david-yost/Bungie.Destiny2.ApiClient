...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Forum_GetForumTagSuggestions_200_response")]
    public partial class ForumGetForumTagSuggestions200Response : IEquatable<ForumGetForumTagSuggestions200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumGetForumTagSuggestions200Response" /> class.
        /// </summary>
        ...
        public ForumGetForumTagSuggestions200Response(List<TagsModelsContractsTagResponse> response = default(List<TagsModelsContractsTagResponse>), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public List<TagsModelsContractsTagResponse> Response { get; set; }
        ...
        {
            return this.Equals(input as ForumGetForumTagSuggestions200Response);
        }

        /// <summary>
        /// Returns true if ForumGetForumTagSuggestions200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumGetForumTagSuggestions200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumGetForumTagSuggestions200Response input)
        {
            if (input == null)
            {
                return false;
