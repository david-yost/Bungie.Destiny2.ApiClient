...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Destiny2_GetVendor_200_response")]
    public partial class Destiny2GetVendor200Response : IEquatable<Destiny2GetVendor200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Destiny2GetVendor200Response" /> class.
        /// </summary>
        ...
        public Destiny2GetVendor200Response(DestinyResponsesDestinyVendorResponse response = default(DestinyResponsesDestinyVendorResponse), int errorCode = default(int), int throttleSeconds = default(int), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Destiny2GetVendor200Response {\n");
        ...
        {
            return this.Equals(input as Destiny2GetVendor200Response);
        }

        /// <summary>
        /// Returns true if Destiny2GetVendor200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of Destiny2GetVendor200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Destiny2GetVendor200Response input)
        {
            if (input == null)
            {
                return false;
